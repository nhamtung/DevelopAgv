 ...
 */
ROS2D.PoseEstimate = function(options) {
	console.log("PoseEstimate.js-17-PoseEstimate");
	var that = this;
	options = options || {};
	var ros = options.ros;
	this.rootObject = options.rootObject || new createjs.Container();
	var actionTopic = options.actionTopic || '/amcl';
	var actionMsgType = options.actionMsgType || 'geometry_msgs/PoseWithCovarianceStamped';
...
ROS2D.NavGoal.prototype.initScale = function() {
	console.log("NavGoal.js-64-initScale");
...
ROS2D.NavGoal.prototype.startGoalSelection = function(pos) {
	console.log("NavGoal.js-81-startGoalSelection");
...
ROS2D.NavGoal.prototype.orientGoalSelection = function(pos) {
	console.log("NavGoal.js-96-orientGoalSelection");
	this.goalOrientationMarker.scaleX = 1.0 / this.stage.scaleX;
	this.goalOrientationMarker.scaleY = 1.0 / this.stage.scaleY;
...
ROS2D.NavGoal.prototype.endGoalSelection = function() {
	console.log("NavGoal.js-112-endGoalSelection");
	this.goalOrientationMarker.visible = true;
